...
// High-fidelity cinematic vertical snap dimensions
export const REEL_CARD_HEIGHT = 540;
export const REEL_CARD_GAP = 16;
export const SNAP_INTERVAL = REEL_CARD_HEIGHT + REEL_CARD_GAP;
...
export const ReelsScreen: React.FC<ReelsScreenProps> = ({
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? '#0B0C13' : '#F5F6FA' }]}>
      {/* High-Fidelity Cinematic Vertical Snapping ScrollView with Pull-to-Refresh */}
      <ScrollView
        ...
        {reels.map((reel) => (
          <View key={reel.id} style={styles.cardContainer}>
            ...
            >
              ...
              {/* Floating Engagement Capsule Pill (Exact Replica from Reference) */}
